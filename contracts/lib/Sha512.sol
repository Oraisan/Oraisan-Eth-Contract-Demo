...
library Sha512 {
    ...
    // @return uint64 
    function ROTR(uint64 x, uint256 n) public pure returns (uint64) {
        return (x << (64 - n)) + (x >> n);
    }
    ...
    // @return uint64 
    function SHR(uint64 x, uint256 n) public pure returns (uint64) {
        return uint64(x >> n);
    }
    ...
    // @param x x
    // @return uint64
    function gamma0(uint64 x) public pure returns (uint64) {
    ...
    // @param x x
    // @return uint64
    function gamma1(uint64 x) public pure returns (uint64) {
