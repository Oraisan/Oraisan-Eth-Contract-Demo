exports.owner = exports.rdOwnerERC20Token = exports.rdOwnerLib_AddressManager = exports.rdOwnerOraisanBridge = exports.rdOwnerOraisanGate = exports.rdOwnerCosmosValidators = exports.rdOwnerCosmosBlockHeader = exports.rdOwnerAVL_Tree = exports.rdOwnerProcessString = void 0;
...
const rdOwnerERC20Token = async () => {
    const RandERC20Token = await ethers.getContractFactory("ERC20Token");
    const rdERC20Token = RandERC20Token.attach(process.env.ETH_TOKEN);
    const rdOwnerERC20Token = rdERC20Token.connect(owner);
    return rdOwnerERC20Token;
}
exports.rdOwnerERC20Token = rdOwnerERC20Token;
